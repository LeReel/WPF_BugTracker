...
namespace GoogleSheetsHelper
{
    public class GoogleSheetsHelper
    {
        ...
        static string ApplicationName = "BugTracker";
        ...
        public void AddCells(GoogleSheetParameters googleSheetParameters, List<GoogleSheetRow> rows)
        {
            ...
            // It's a batch request so you can create more than one request and send them all in one batch.
            // Just use reqs.Requests.Add() to add additional requests for the same spreadsheet
